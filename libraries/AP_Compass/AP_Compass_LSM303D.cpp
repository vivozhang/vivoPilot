...
// detect the sensor
AP_Compass_Backend *AP_Compass_LSM303D::detect(Compass &compass)
{
...
bool AP_Compass_LSM303D::read_register(uint8_t address, uint8_t *value)
{
    uint8_t addr = address | 0x80; // Set most significant bit
...
bool AP_Compass_LSM303D::write_register(uint8_t address, uint8_t value)
{
    uint8_t tx[2];
    uint8_t rx[2];
...
void AP_Compass_LSM303D::accumulate(void)
{
}
