...
public:
    ...
    virtual uint8_t write_rpio(uint8_t addr, uint8_t reg, uint8_t offset, uint8_t len, uint8_t* data) = 0;
    ...
    virtual uint8_t read_rpio(uint8_t addr, uint8_t reg, uint8_t offset, uint8_t len, uint8_t* data) = 0;
